all: kmc kmc_dump kmc_tools py_kmc_api smudge_pairs find_corrections get_counts smooth remove_het uniq
...
uniq: $(KMC_DUMP_DIR)/uniq.o $(KMC_DUMP_DIR)/uniq_main.o
	g++ $(KMC_DUMP_DIR)/uniq.o $(KMC_DUMP_DIR)/uniq_main.o -o uniq $(CFLAGS)
